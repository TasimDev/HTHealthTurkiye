const servicesData = [
    ...
    },
    {
        ...
        info: {
            small_info: 'Процедурата за присаждане на коса в Турция с HTHealthTurkiye представлява персонализиран и иновативен подход към решаването на проблема с косопада. Нашите опитни и квалифицирани хирурги, специализирани в областта на естетичната хирургия, извършват внимателно изваждане и присаждане на фоликули, за да постигнат естествен и траен резултат.',
            big_info: {
